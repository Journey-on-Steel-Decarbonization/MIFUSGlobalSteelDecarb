...
\begin{itemize}[leftmargin=*]
    \item \textbf{2030 Target:} 30\% reduction in total CO2 emissions compared to 2013 baseline (200 million tons)
...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Product-Based Solutions:} Providing high-performance steel products that contribute to CO2 reduction throughout society (downstream emissions reduction)
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Goal:} Halve CO2 emissions using heated external hydrogen
    \item \textbf{Achievement (2023):} Confirmed 33\% CO2 reduction in test blast furnace (world record)
...
\begin{itemize}[leftmargin=*]
    ...
    \item Technologies established for 50\% CO2 reduction
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Commitment:} Maintains 30\% CO2 reduction target by 2030
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Feedstock:} Uses recycled steel scrap, sharply reducing CO2 emissions
...
\begin{itemize}[leftmargin=*]
    ...
    \item Steel sector emits half the CO2 per tonne vs. Japan
