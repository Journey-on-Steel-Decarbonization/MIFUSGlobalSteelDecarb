...
\begin{itemize}
    ...
    of operational challenges and unintended consequences
...
\textbf{Policy Mechanism:} The "Implementation Plan for Ultra-Low Emissions in the Steel Industry" mandates specific limits for particulate matter (10 mg/m\textsuperscript{3}), SO\textsubscript{2} (50 mg/m\textsuperscript{3}), and NO\textsubscript{x} (150 mg/m\textsuperscript{3}) by 2025.

\textbf{Implementation Reality:} While primarily targeting conventional pollutants rather than CO\textsubscript{2}, the ULE mandate creates a significant "CO\textsubscript{2} penalty" due to the additional energy required for advanced filtration systems. This unintended consequence forces simultaneous investment in energy efficiency improvements, creating a powerful driver for comprehensive process optimization across the entire BF-BOF fleet.
...
\textbf{Carbon Capture, Utilization and Storage:} Chinese approaches focus on pragmatic applications with potential economic returns, such as utilizing captured CO\textsubscript{2} in chemical production, creating viable business cases for early implementation.
